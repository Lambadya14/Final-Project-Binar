  ...
  const renderFilteredMap = () => {
    if (filteredData.length > 0) {
      return filteredData.map((details) => {
        return (
          <Card
            onClick={() => handleOptionClick(details.id)}
            ...
            style={{
              width: "30rem",
              border:
                selectedOption === details.id ? "1px solid #7126B5BF" : "",
              boxShadow:
            ...
            >
              ...
              >
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <Card.Text>
                    <span style={{ color: "#A06ECE" }}>
                      <strong>{currencyFormatter(selectedOption.tax)}</strong>
                    </span>
                  </Card.Text>
                </div>
              </ListGroup>
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <Card.Text>
                    <span style={{ color: "#A06ECE" }}>
                      <strong>
                        {currencyFormatter(
                          selectedOption.adult * +selectedOption.flight_price +
                            +selectedOption.tax
                        )}
                      </strong>
                    </span>
