...
const BookingForm = (props) => {
  ...
  const buttonClick = (event) => {
    ...
    navigate(
      `/search?dep_airport=${dataFrom.value}&arr_airport=${
        dataTo.value
      }&departure_time=${departureDate}&personr=${totalPassenger(
        selectedPassengers
      )}&seatclass=${dataClass.value}`
    );
  };
        ...
        <Col xs={12} md={11}>
          <Card bg="light" border="light" className="card-size">
            <h3 className="fw-bold m-4">
              ...
              <span className="text-color">AirTix</span>
            </h3>
            <Card.Body>
              <Form>
                <Row>
                  ...
                  <Col>
                    <Form.Group onSubmit={handleClick} className="mb-3">
                      <img
                        src={dateVector}
                        alt="date"
                        className="font-button font-size"
                      />
                ...
                <Col className="p-2 text-center">
                  <Button
                    ...
                    onClick={buttonClick}
                    style={{ backgroundColor: "#7126B5", border: "0px" }}
                  >
                    Cari Penerbangan
                  </Button>
                </Col>
